...
public class BaiduMapConstants {
    public final static String BAIDU_MAP_API_AND_SYMBOL = "&";
    public final static String BAIDU_MAP_API_EQUAL_SYMBOL = "=";
    public final static String BAIDU_MAP_API_QUESTION_SYMBOL = "?";
    public final static String BAIDU_MAP_API_COMMA_SYMBOL = ",";
    public final static String BAIDU_MAP_API_OUTPUT_KEY = "output";
    public final static String BAIDU_MAP_API_OUTPUT_VALUE = "json";
    public final static String BAIDU_MAP_API_AK_KEY = "ak";
    public final static String BAIDU_MAP_API_SN_KEY = "sn";
